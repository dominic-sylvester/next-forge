...
const Self =
  ...
  Prism = ((e) => {
    let t = /\blang(?:uage)?-([\w-]+)\b/i,
      ...
      r = {
        ...
        util: {
          ...
          getLanguage(e) {
            while (e && !t.test(e.className)) {
              e = e.parentElement;
            }
            return e
              ? (e.className.match(t) || [undefined, "none"])[1].toLowerCase()
              : "none";
          },
          currentScript() {
          ...
          insertBefore(e, t, a, n) {
            ...
            for (const l in s) {
              if (Object.hasOwn(s, l)) {
                if (l === t) {
                  for (const o in a) {
                    Object.hasOwn(a, o) && (i[o] = a[o]);
                  }
                }
                Object.hasOwn(a, l) || (i[l] = s[l]);
              }
            }
            const u = n[e];
            return (
        ...
        highlightElement(a, n, s) {
          ...
          if (
            ...
            return r.hooks.run("complete", u), void s?.call(u.element);
          }
        ...
        if (Object.hasOwn(a, d) && a[d]) {
          ...
          for (let m = 0; m < p.length; ++m) {
            ...
            if (b && !h.pattern.global) {
              ...
              h.pattern = new RegExp(h.pattern.source, `${F}g`);
            }
            for (
    ...
    function c(e, t, a) {
      for (let n = t.next, r = 0; r < a && n !== e.tail; r++) {
        n = n.next;
      }
        ...
        Prism.hooks.add("before-sanity-check", (s) => {
          ...
          if (i.matches(r)) {
            ...
            let u = i.getAttribute("data-src"),
              c = s.language;
            if (c === "none") {
              const g = (/\.(\w+)$/.exec(u) || [undefined, "none"])[1];
              c = e[g] || g;
            }
            l(o, c), l(i, c);
